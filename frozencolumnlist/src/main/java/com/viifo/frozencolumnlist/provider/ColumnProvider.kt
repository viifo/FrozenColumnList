...
interface ColumnProvider<T : FrozenColumnData> {
     ...
     */
    fun createFrozenViews(parent: ViewGroup, size: Int): List<View>
     ...
     */
    fun createScrollableViews(parent: ViewGroup, size: Int): List<View>
     ...
     */
    fun bindFrozenViews(views: List<View>, data: T, payloads: List<Any?>)
     ...
     * @param payloads 局部刷新数据, 为空时表示全量刷新
     */
    fun bindScrollableViews(views: List<View>, data: T, payloads: List<Any?>)
